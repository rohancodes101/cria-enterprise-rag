...
INDEX_PATH = find_existing_path([
    os.path.join(BASE_DIR, "embeddings", "granite_cr_index.bin"),
    os.path.join(BASE_DIR, "embeddings", "granite_cr_index.bin"),
])

META_PATH = find_existing_path([
    os.path.join(BASE_DIR, "embeddings", "granite_cr_metadata.pkl"),
    os.path.join(BASE_DIR, "embeddings", "granite_cr_metadata.pkl"),
])
...
# UI (DASHBOARD LAYOUT)
# =====================================================
# Using Gradio's Soft theme as a base for modern inputs, paired with our custom CSS
# =====================================================
# UI (DASHBOARD LAYOUT)
# =====================================================
